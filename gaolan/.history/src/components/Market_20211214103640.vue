            ...
            <div class="jj_cont">
              ...
              <div class="content">
                <el-carousel
                  ...
                  :interval="20000"
                  @mouseenter.native="delHandleMouseEntera"
                >
                  <el-carousel-item
              ...
              <div class="xc_cont">
                ...
                <div class="content">
                  <el-carousel
                    ...
                    indicator-position="none"
                    :interval="20000"
                    @mouseenter.native="delHandleMouseEnterb"
                  >
                    <el-carousel-item
...
export default {
  ...
  mounted() {
    ...
    this.$refs.carousela.handleMouseEnter = () => { };
    this.$refs.carouselb.handleMouseEnter = () => { };
  },
  beforeDestroy() {
  ...
  methods: {
    delHandleMouseEnter() {
      ...
      delHandleMouseEntera() {
          this.$refs.carousela.handleMouseEnter = () => {};
      },
      delHandleMouseEnterb() {
          this.$refs.carouselb.handleMouseEnter = () => {};
      },
    // 场馆数量
    changguannum() {
